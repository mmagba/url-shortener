...
const Hero = () => {
    return (
        <section className='overflow-x-hidden md:pb-20'>
            <div className="flex flex-col-reverse md:flex-row mx-auto custom__container justify-between mt-20 relative ">
                ...
                <div className='flex flex-col mb-32 pt-6 md:pt-14 md:w-7/12 gap-4'>
                    ...
                    <div className="flex justify-center md:justify-start mt-5 ">
                        <button className='bg-cyan text-white rounded-full pb-4 px-14 pt-4 hover:bg-lightCyan drop-shadow-xl max-w-7xl font-semibold'>
                            Get Started
                        </button>
                    </div>
                </div>
